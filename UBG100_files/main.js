...
//Fetch visit count
const visitapi = "https://api.countapi.xyz/update/weblfg/894b3dcd-ec09-40e8-ad52-6d5f4e5e984a/?amount=1";
fetch(visitapi)
.then((res) => res.json())
.then((res) => {
...
$header.innerHTML = `<div class="banner"><p>There is a new update! Check out&nbsp<a href="https://weblfg.com/">weblfg.com</a>! Join the Discord for more links.</p></div>
<nav class="aa-nav">
